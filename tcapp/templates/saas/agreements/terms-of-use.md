...
7.1 After all income and asset information has been obtained and calculated,
    all qualified sources of income are added to derive the total household
    income. In order for the household to qualify for a tax credit unit,
    the total household income must be less than or equal to the maximum
    allowable qualifying income for household size in effect at the time
    of tenant certification. If the total household income is greater than
    the maximum allowable qualifying income, the household cannot be certified
    for a tax credit unit.
